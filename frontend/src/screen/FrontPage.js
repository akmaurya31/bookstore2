...
.swiper-containers .swiper-slide:nth-child(even) {
 ...
 <section className="bfcstore_banner">
  ...
  // b1 = require(`../../src/images/books/${product.image}`);
  b1 = require('../../src/images/books/b2.jpeg'),
  b2 = require('../../src/images/books/b2.jpeg'),
  b3 = require('../../src/images/books/b3.jpeg'),
  b4 = require('../../src/images/books/b4.jpeg'),
  b5 = require('../../src/images/books/b5.jpeg'),
  b6 = require('../../src/images/books/b6.jpeg'),
  b7 = require('../../src/images/books/b7.jpeg')
...
<div className="swiper-slide" style={{backgroundImage: `url(${b1})`, backgroundSize:`cover`, backgroundRepeat:`no-repeat`}}/>

                <div className="swiper-slide dddddddsss"  style={{backgroundImage: `url(${b2})`, backgroundSize:`cover`, backgroundRepeat:`no-repeat`}}/>
                  ...
                  <div className="swiper-slide" style={{backgroundImage: `url(${b6})`, backgroundSize:`cover`, backgroundRepeat:`no-repeat`}}/>
                  <div className="swiper-slide" style={{backgroundImage: `url(${b7})`, backgroundSize:`cover`, backgroundRepeat:`no-repeat`}}/>
